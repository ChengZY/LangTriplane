...
if __name__ == "__main__":
    ...
    parser.add_argument('--feat_dir', type=str, default="/data/resize8/sofa/language_features_resize8")
    parser.add_argument("--ae_ckpt_dir", type=str, default=None)
    parser.add_argument("--output_dir", type=str, default="/data/resize8/sofa/eval")
